...
// function ShopOwnerEditProfile() {

// const storedData=JSON.parse(localStorage.getItem("user"))

//     const URL = "http://localhost:3000/shopOwner/editProfile"
...
//         <>
//             <ShopOwnerHeader />
//             <h3 style={{textAlign:"center",marginTop:"5vh"}}>Edit Your Profile</h3>
...
//                     <h1 className="card-title">Welcome shopOwner {emailId}</h1>
...
function ShopOwnerEditProfile() {
  ...
  return (
    <>
      ...
      <div className="card shadow-lg" style={{ width: "45%", margin: "50px auto", borderRadius: "12px" }}>
        <form onSubmit={submitData} style={{ padding: "25px" }}>
          <div className="card-body">
            <h5 style={{ marginBottom: "25px", color: "#333", fontWeight: "600" }}>
              Welcome Shop Owner <span style={{ color: "#0d6efd" }}>{emailId}</span>
            </h5>
            ...
            <button
              ...
              style={{ width: "100%", padding: "10px", fontWeight: "600", borderRadius: "8px" }}
            >
              Update Profile
            </button>
          </div>
